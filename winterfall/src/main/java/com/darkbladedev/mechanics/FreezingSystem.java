...
public class FreezingSystem implements Listener {
     ...
     */
    public FreezingSystem(WinterfallMain plugin) {
        this.plugin = plugin;
    ...
    public void initialize() {
        if (!isActive) {
            ...
            isActive = true;
            plugin.getServer().getConsoleSender().sendMessage(MiniMessage.miniMessage().deserialize(WinterfallMain.PREFIX + " <aqua>Sistema de congelación activado</aqua>"));
        }
    }
    ...
    public void shutdown() {
        ...
        isActive = false;
        plugin.getServer().getConsoleSender().sendMessage(MiniMessage.miniMessage().deserialize(WinterfallMain.PREFIX + " <red>Sistema de congelación desactivado</red>"));
    }
