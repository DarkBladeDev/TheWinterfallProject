...
public class CustomDamageTypes {
    ...
    private static WinterfallMain plugin;
    // Claves para los tipos de daño personalizados
    public static final Key BLEEDING_KEY = Key.key("winterfall:bleeding");
    public static final Key DEHYDRATION_KEY = Key.key("winterfall:dehydration");
    public static final Key FREEZING_KEY = Key.key("winterfall:freezing");
