...
public class CustomEnchantments {
    ...
    public static final Key CONGELATION_KEY = Key.key("winterfall:freeze");
    public static final Key RADIATION_PROTECTION_KEY = Key.key("winterfall:radiation_protection");    
