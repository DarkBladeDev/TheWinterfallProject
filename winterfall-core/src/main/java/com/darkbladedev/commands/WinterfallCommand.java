...
public class WinterfallCommand implements CommandExecutor, TabCompleter {
    ...
    private void handleSnowCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.snow")) {
    ...
    private void handleEnchantmentCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.enchantment")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleRadiationCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.radiation")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleBleedingCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.bleeding")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleStatusCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.status")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleHydrationCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.hydration")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleNutritionCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.nutrition")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleLimbCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.limb")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
    ...
    private void handleConfigCommand(CommandSender sender, String[] args) {
        // Verificar permisos
        if (!sender.hasPermission("winterfall.admin.config")) {
            ((Audience) sender).sendMessage(MiniMessage.miniMessage().deserialize("<red>No tienes permiso para usar este comando."));
            return;
        }
